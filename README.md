...
### Total Downloads: ![Downloads](### Total Downloads: ![Downloads](https://shieldcn.dev/github/downloads/Gemini-HUN/Spore_Fix_Russian_Locale_Crash.svg?style=flat-square&color=d81b60&logo=github)
...
## Important
This mod works by using the en-us locale internally. Russian localization mods that only modify the Russian locale will not be loaded by the game while using this fix.
